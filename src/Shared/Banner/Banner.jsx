...
const Banner = () => {
    return (
        <div className="flex flex-col items-center justify-center space-y-5 mt-12 p-2 lg:p-0">
            <h1 className="lg:text-5xl text-3xl font-bold text-center text-white">Discover Your Dream Ride at <span className="text-yellow-400">AutoCare</span></h1>
            ...
            <a href='#card' className="btn btn-secondary bg-yellow-400 text-white border-none">Explore <FaArrowRight></FaArrowRight></a>
        </div>
    );
};
